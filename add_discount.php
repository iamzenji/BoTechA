    ...
    if (
        ...
        if (isset($_SESSION['employee_id'])) {
            ...
            try {
                ...
                $select_unit_inv_qty_query = "SELECT unit_inv_qty FROM inventory WHERE supplier = ? AND category = ? AND brand = ? AND type = ? AND unit = ?";
                $select_unit_inv_qty_stmt = mysqli_prepare($connection, $select_unit_inv_qty_query);
                mysqli_stmt_bind_param($select_unit_inv_qty_stmt, "sssss", $supplier, $category, $brand, $type, $unit);
                ...
                $update_query = "UPDATE inventory SET unit_inv_qty = unit_inv_qty - ? WHERE supplier = ? AND category = ? AND brand = ? AND type = ? AND unit = ?";
