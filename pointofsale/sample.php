    ...
    <section class="cart">
        ...
        <table class="table table-striped table-hover" style="width:100%" id="laman_cart">
                ...
                <tr>
                    ...
                    <td>
                        <form action="" method="post">
                            ...
                            <input button class="btn btn-outline-primary" type="submit" value="Update"
            ...
            <tr>
                ...
                <td><a href="pos.php?delete_all" onclick="return confirm('are you sure you want to delete all?');"
