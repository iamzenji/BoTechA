                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="" method="post">
                            ...
                            <input style=" width:40px;" type="number" name="update_quantity" min="1"
                                value="<?php echo $fetch_cart['qty']; ?>">

                            <input button class="btn btn-outline-primary sm" type="submit" value="Update"
                                name="update_update_btn" class="bg-dark-subtle">
                    ...
                    <td><a href="pos.php?remove=<?php echo $fetch_cart['cart_id']; ?>"
                            onclick="return confirm ('remove item ?')" class="delete-btn"><i class="fa fa-remove"
            ...
            ?>
                ...
                <tr>
                    ...
                    <form action="" method="post">
                            ...
                            ?>
                            <input button class="btn btn-outline-success sm" type="submit" value="done"
                                name="cash">
                ...
                <tr>  
                    ...
                    <td colspan="3"><a href="pos.php?delete_all" onclick="return confirm('are you sure you want to delete all?');"
                        class="btn btn-outline-danger"> Delete all </a></td>
