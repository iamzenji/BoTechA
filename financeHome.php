...
if (strlen($_SESSION['employee_id']) === 0) {
    ...
    if (!$salesRecorded) {
        ...
        $dailysales = mysqli_query($connection, "SELECT * FROM finance_daily_sales");
        $salesresult = mysqli_fetch_assoc($dailysales);
        ...
        $salesRecorded = true;
        $salesresult = mysqli_query($connection, "UPDATE finance_daily_sales SET totalsales = 0");
        $sales = mysqli_fetch_assoc($dailysales);
    }
                ...
                <section class="right-window-container">
                    ...
                    <div class="box">
                        <div class="box-title">
                            ...
                            <div class="btn-group">
                                <button disabled class="btn btn-success" data-toggle="modal" data-target="#addBalModal" data-bs-placement=" top" title="Add Balance">+ Add Balance</button>
                                <button class="btn btn-primary" data-toggle="modal" data-target="#receiptModal" data-bs-placement=" top" title="Add Balance">Print Receipt</button>
                            </div>
                            <!-- ------------------------------------------------------------------------------ -->
                            <!-- Add Balance Modal -->
                            <div class="modal fade" id="addBalModal" tabindex="-1" aria-labelledby="addbalLabel" role="dialog" aria-hidden="true">
                                        ...
                                        <form action=financeConfigAdd.php method="POST">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" min="0" name="addbal" required>
                                                </div>
                                            </div>
                            ...
                            <!-- ------------------------------------------------------------------------------ -->
                            <!-- Receipt Modal -->
                            <div class="modal fade" id="receiptModal" tabindex="-1" aria-labelledby="receiptLabel" role="dialog" aria-hidden="true">
                                <div class="modal-dialog mailinfo modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-footer">
                                            <button class="btn btn-success" onclick="window.print()">Save &
                                                Print</button>
                                            <button class="btn btn-secondary" data-dismiss="modal" aria-label="Close">Back</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="box">
                        <div class="box-title">
                            ...
                            <div class="tablebtn-container">
                                <!-- Add title button -->
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#expensesAddModal">Add</button>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($expresult)) {
                                    ...
                                    <tr>
                                        ...
                                        <td> <button class="btn btn-danger" id="expensesRemoveModal-<?= $row['id']; ?>" data-toggle="modal" data-target="#expensesRemoveModal-<?= $row['id']; ?>">Remove</button></td>
                                    </tr>
                                    <!-- ---------------------------------------------------------------------------------------- -->
                                    <!-- Remove Expense Modal -->
                                    <div class="modal fade" id="expensesRemoveModal-<?= $row['id']; ?>" aria-labelledby="expensesRemoveModalLabel-<?= $row['id']; ?>" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable">
                                            <form action="financeConfigAdd.php" method="post">
                                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="expensesRemoveModalLabel-<?= $row['id']; ?>">Confirm</h5>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-danger" name="removeexpense">Yes</button>
                                    ...
                                    <!-- ---------------------------------------------------------------------------------------- -->
                                    <!-- Add Expense Modal -->
                                    <div class="modal fade" id="expensesAddModal" tabindex="-1" aria-labelledby="expensesAddModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable">
                                            <form action="financeConfigAdd.php" method="post">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="expenses-name" name="expenses-name">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="expenses-cost" class="form-label">Cost</label>
                                                            <input type="number" min="0" class="form-control" id="expenses-cost" name="expenses-cost">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-success" name="addexpense">Add</button>
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal" aria-label="Close">Back</button>
                                                    </div>
                                                </div>
                                            </form>
