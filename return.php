...
<body>
<div class="wrapper">
    <div class="modal fade" id="reportreturn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form action="returndb.php" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="supplier" id="supplier" class="form-control select-tag" required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="reason_return" class="form-control" required>
                                <option value="" disabled>--reason for report--</option>
                    ...
                    if ($result) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                $disabled = ($row['return_name'] == 'Accepted' || $row['return_name'] == 'Declined') ? 'disabled' : '';
                                echo "<tr>";
                                ...
                                echo "<td>";
                                echo "<button type='button' id='acceptBtn_" . $row['id'] . "' class='btn btn-success btn-sm mr-1' onclick='acceptReturn(" . $row['id'] . ")' $disabled>Accept</button>";
                                echo "<button type='button' id='declineBtn_" . $row['id'] . "' class='btn btn-danger btn-sm' onclick='declineReturn(" . $row['id'] . ")' $disabled>Decline</button>";
                                echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";
